	...
	extends JPanel
{
	...
	public PodmiotPanel()
		throws SQLException
	{
		setBorder( new TitledBorder( UIManager.getBorder( "TitledBorder.border" ), "Dane podmiotu",
	...
	public Podmiot pobierzZFormatki() throws Exception
	{
		...
		return new Podmiot( textNazwa.getText(), textUlica.getText(), textKodPocztowy.getText(),
				textMiasto.getText(), textNIP.getText() );
	}
}
