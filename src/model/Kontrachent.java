    ...
    implements ObiektZId
{
    ...
    public final static String[] kolumnyPrzeszukiwania = { "nazwa", "miasto", "kod_pocztowy", "ulica", "regon",
        "nr_konta", "nip" };
    ...
    public Kontrachent( String nazwa, String miasto, String kod_pocztowy, String ulica, int cena_mnoznik,
                        boolean widoczny, String nip, String regon, String nrKonta, int kredyt_kupiecki, int id )
    {
        this.nazwa = nazwa;
        this.miasto = miasto;
